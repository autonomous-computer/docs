...
description: "Give an agent one narrow filing-research job, an evidence standard, and clear stop conditions"
---

A skill tells an agent how to do one job repeatedly. SEC API does not prescribe
a universal skill format, installer, scheduler, or secret store. Keep the SEC
API portion portable: name the job, the retrieval path, the evidence to keep,
and the point where the agent must stop.
