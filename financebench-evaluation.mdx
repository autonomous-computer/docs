---
title: "FinanceBench Evaluation — SEC API"
description: "How the SEC API scores on the FinanceBench financial QA benchmark, including the agent harness, tool stack, and per-question results."
---
