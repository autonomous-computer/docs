...
description: "Return related stocks ranked by factor-overlap similarity for peer discovery and hedge ideation"
---
...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/factors/related-stocks?symbol=AAPL&response_mode=compact&include=trust"
```
</RequestExample>
...
<Prompt>
Use SEC API GET /v1/factors/related-stocks to return related stocks ranked by factor-overlap similarity for peer discovery and hedge ideation. Preserve `requestId`, `traceparent` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
