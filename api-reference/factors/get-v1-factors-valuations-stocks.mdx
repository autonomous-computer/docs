---
title: "GET /v1/factors/valuations/stocks"
description: "Return stock candidates exposed to a valuation-factor signal using latest materialized factor exposures"
---
