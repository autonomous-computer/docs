...
Use SEC API GET /v1/factors/exposures to return security, portfolio, or watchlist factor exposures with model metadata and provenance. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
