...
<Card title="GET /v1/factors/macro-sensitivity" href="/api-reference/factors/get-v1-factors-macro-sensitivity">Return explainable heuristic factor sensitivity to macro scenarios and shocks</Card>
