...
description: "Return a one-call portfolio intelligence bundle with exposures, stress scenarios, events, and hedge ideas"
---

# POST /v1/intelligence/portfolio

Return a one-call portfolio intelligence bundle with exposures, stress scenarios, events, and hedge ideas
...
<Prompt>
Use SEC API POST /v1/intelligence/portfolio for a one-call portfolio intelligence bundle. Preserve factor exposures, stress scenarios, events, hedge ideas, freshness, methodology, `requestId`, and `traceparent`, and keep the response compact unless the caller asks for expanded evidence.
</Prompt>
