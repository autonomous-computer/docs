...
description: "Search SEC EDGAR entity records by name, ticker, CIK, or identifier"
---

# GET /v1/entities/edgar

Search SEC EDGAR entity records by name, ticker, CIK, or identifier
...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/entities/edgar"
```
</RequestExample>
