...
Use SEC API GET /v1/entities to search canonical SEC entities across issuers, managers, insiders, and funds. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
