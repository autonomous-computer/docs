...
<Card title="GET /v1/situations/issues/{issue}" href="/api-reference/situations/get-v1-situations-issues-issue">Retrieve one frozen weekly issue by issue number or slug.</Card>
...
<Card title="GET /v1/situations/{situation_id}/underwriting-pack" href="/api-reference/situations/get-v1-situations-situation-id-underwriting-pack">Build a source-cited underwriting pack from public canonical detail, the SEC timeline, and Copy-for-LLM markdown</Card>
