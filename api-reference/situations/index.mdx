...
<Card title="GET /v1/situations/stats" href="/api-reference/situations/get-v1-situations-stats">Situation counts by type, status, sector, market-cap bucket, and country with coverage scope</Card>
