...
- `SECAPI-Meter-Class: situations_lookup`
- `Request-Id`
- `traceparent`
...
The export currently uses the `situations_lookup` meter class, the same standard-read family as other authenticated Special Situations requests. Inspect the response headers and your organization's billing endpoints before planning sustained export volume; rates and limits can change independently of the route contract.
