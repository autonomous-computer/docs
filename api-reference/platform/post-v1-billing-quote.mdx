...
Use SEC API POST /v1/billing/quote to quote a billable workflow or meter class against the current billing plan and budget gates. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
