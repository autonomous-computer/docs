...
Use SEC API POST /v1/billing/payg/activate to create a Stripe checkout setup session that activates pay as you go card-on-file billing. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
