...
Use SEC API GET /v1/events to list canonical event, webhook delivery, and stream records for the current organization. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
