...
Use SEC API POST /v1/billing/checkout to create a stripe checkout session for a self-serve personal or team SEC API plan. Preserve `requestId`, `traceparent` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
