...
Use SEC API POST /v1/billing/portal to create a Stripe billing portal session for the current organization. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
