...
Use SEC API POST /v1/billing/portal to create a stripe billing portal session for the current organization. Preserve `requestId`, `traceparent` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
