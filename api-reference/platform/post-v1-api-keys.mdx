...
Use SEC API POST /v1/api_keys to create a new API key for the current organization. Preserve `requestId`, `traceparent` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
