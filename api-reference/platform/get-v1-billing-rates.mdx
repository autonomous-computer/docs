...
Use SEC API GET /v1/billing/rates to return the public pricing catalog, plan metadata, and meter-family rates. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
