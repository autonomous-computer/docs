...
Use SEC API GET /v1/events/auditor-changes to return 8-K item 4.01 auditor change events with change-type classification (dismissal, resignation, engagement). Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
