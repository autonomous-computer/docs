...
Use SEC API `GET /v1/api_keys` to list API keys for the current organization. Preserve `requestId` and `traceparent` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
