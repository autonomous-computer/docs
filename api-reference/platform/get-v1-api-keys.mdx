...
Use SEC API `GET /v1/api_keys` to list API keys for the current organization. Preserve `requestId` and `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
