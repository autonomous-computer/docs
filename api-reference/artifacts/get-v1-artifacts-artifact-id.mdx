...
description: "Fetch persisted artifact metadata"
---
...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/artifacts/art_example_123"
```
</RequestExample>
...
<Prompt>
Use SEC API GET /v1/artifacts/{artifact_id} to fetch persisted artifact metadata. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
