...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/artifacts/art_example_123/download"
```
</RequestExample>
...
Use SEC API GET /v1/artifacts/{artifact_id}/download to download or redirect to the persisted artifact payload. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
