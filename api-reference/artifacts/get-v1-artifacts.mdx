...
Use SEC API GET /v1/artifacts to list canonical artifacts for the current organization. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
