...
Use SEC API POST /v1/artifacts to create and persist a derived artifact bundle. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
