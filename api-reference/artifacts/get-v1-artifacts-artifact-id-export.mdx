...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/artifacts/art_example_123/export"
```
</RequestExample>
...
Use SEC API GET /v1/artifacts/{artifact_id}/export to export an artifact as structured JSON or a markdown-oriented download envelope. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
