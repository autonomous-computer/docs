...
description: "Return a first-party SEC company overview — a due-diligence briefing combining identity/classification (name, CIK, tickers, sector/industry from SIC, state…"
---
...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/companies/overview"
```
</RequestExample>
