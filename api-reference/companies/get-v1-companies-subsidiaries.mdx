...
Use SEC API GET /v1/companies/subsidiaries to return the list of subsidiaries extracted from the latest 10-k exhibit 21 for a given entity. Preserve `requestId`, `traceparent` in the output. Return a concise summary and preserve the structured fields your application needs for follow-up requests.
</Prompt>
