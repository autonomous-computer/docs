...
Use SEC API GET /v1/companies/subsidiaries to return the list of subsidiaries extracted from the latest 10-K exhibit 21 for a given entity. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
