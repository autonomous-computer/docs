...
description: "Retrieve an issuer's statement-derived profitability, return, valuation, dividend, and leverage ratios with period context"
---

Retrieve an issuer's statement-derived profitability, return, valuation, dividend, and leverage ratios with period context
...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/companies/ratios?ticker=AAPL"
```
</RequestExample>
