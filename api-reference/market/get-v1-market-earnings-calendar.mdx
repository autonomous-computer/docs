...
Use SEC API GET /v1/market/earnings-calendar to return upcoming and recent earnings events with consensus estimates, actuals, and surprise data. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
