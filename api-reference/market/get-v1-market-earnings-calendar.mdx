...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/market/earnings-calendar"
```
</RequestExample>
...
Use SEC API GET /v1/market/earnings-calendar to return upcoming and recent earnings events with consensus estimates, actuals, and surprise data. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise summary and preserve the structured fields your application needs for follow-up requests.
</Prompt>
