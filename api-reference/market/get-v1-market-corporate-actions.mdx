...
Use SEC API GET /v1/market/corporate-actions to return rights-reviewed corporate actions used to normalize price history and event analysis. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
