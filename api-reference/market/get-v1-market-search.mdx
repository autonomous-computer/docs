...
Use SEC API GET /v1/market/search to search for stock tickers by company name or keyword. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
