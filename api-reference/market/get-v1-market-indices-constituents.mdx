...
```json
{
  ...
  "index": {
    ...
    "notes": "Constituent roster is parsed from Nasdaq's public Nasdaq-100 companies table. Weights are not published on the source page, so SEC API returns rank order and symbol-level golden-record mapping only.",
    "provenance": {
      "source": "index_provider",
      "accessionNumber": null,
      "filingUrl": "https://www.nasdaq.com/solutions/global-indexes/nasdaq-100/companies",
