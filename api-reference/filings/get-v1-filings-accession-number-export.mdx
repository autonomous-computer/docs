...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/filings/{accession_number}/export"
```
</RequestExample>
...
Use SEC API GET /v1/filings/{accession_number}/export to export a filing as json, markdown, csv, xlsx, docx, or pdf. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise summary and preserve the structured fields your application needs for follow-up requests.
</Prompt>
