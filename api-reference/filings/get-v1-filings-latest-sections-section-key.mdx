...
Use SEC API GET /v1/filings/latest/sections/{section_key} to extract a section from the latest filing for an entity and form. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
