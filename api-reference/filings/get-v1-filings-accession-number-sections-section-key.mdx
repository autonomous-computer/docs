...
Use SEC API GET /v1/filings/{accession_number}/sections/{section_key} to extract a filing item or section from a specific accession-number filing. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
