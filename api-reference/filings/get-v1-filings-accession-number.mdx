...
curl -X GET \
  ...
  "https://api.secapi.ai/v1/filings/0000320193-25-000079"
```
</RequestExample>
...
Use SEC API GET /v1/filings/{accession_number} to retrieve a filing manifest by accession number from the materialized filing corpus. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
