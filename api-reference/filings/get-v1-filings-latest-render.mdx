...
Use SEC API GET /v1/filings/latest/render to render the latest filing into markdown-like text. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
