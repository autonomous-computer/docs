...
<Card title="GET /v1/macro/status" href="/api-reference/macro/get-v1-macro-status">Return macro source-health, country coverage, freshness, and source-rights posture from validation artifacts</Card>
</CardGroup>
