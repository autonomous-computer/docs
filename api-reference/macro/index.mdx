...
<Card title="GET /v1/macro/high-signal-pack" href="/api-reference/macro/get-v1-macro-high-signal-pack">Return the high-signal high-signal macro pack with explicit source, fallback, and release-calendar posture for supported countries</Card>
