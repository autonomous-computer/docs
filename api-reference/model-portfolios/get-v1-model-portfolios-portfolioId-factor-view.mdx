---
title: "GET /v1/model-portfolios/{portfolioId}/factor-view"
description: "Return a model-portfolio factor view with aggregate analysis and per-position exposures for drill-down workflows"
---
