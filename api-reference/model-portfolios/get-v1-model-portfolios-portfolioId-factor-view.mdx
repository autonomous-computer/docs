...
Use SEC API GET /v1/model-portfolios/{portfolioId}/factor-view to return a model-portfolio factor view with aggregate analysis and per-position exposures for drill-down workflows. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
