...
Use SEC API GET /v1/owners/13f/filings to list recent 13F filings, including quarter-end report dates, for a manager CIK. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
