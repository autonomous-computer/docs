...
Use SEC API POST /v1/compensation/compare to compare the latest two executive compensation disclosures for an issuer. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
