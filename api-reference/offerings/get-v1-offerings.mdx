...
<Prompt>
Use SEC API GET /v1/offerings to find SEC registration statements and prospectuses for public-offering research. Preserve `requestId`, `traceparent`, `provenance`, `freshness`, `materialization` in the output. Return a concise markdown summary plus the exact structured payload fields that a downstream engineer or agent should keep using this result.
</Prompt>
