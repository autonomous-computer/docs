...
<Card title="Filings" icon="file-text" href="/api-reference/filings">Find SEC filings, then retrieve, render, extract, compare, or export a selected source record; filing-intelligence routes are currently unavailable.</Card>
...
<Card title="Statements" icon="table-properties" href="/api-reference/statements">Read SEC-derived, normalized statements and disclosed segment history with period and source context.</Card>
