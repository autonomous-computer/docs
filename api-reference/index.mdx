...
<Card title="Companies" icon="building" href="/api-reference/companies">Canonical company financials, ratios, and statements backed by SEC XBRL and MASSIVE data.</Card>
...
<Card title="Traces" icon="waypoints" href="/api-reference/traces">Trace hydration, filing page anchors, and source-to-derived lineage workflows.</Card>
