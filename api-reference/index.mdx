...
<CardGroup cols={2}>
<Card title="Advisers" icon="square-stack" href="/api-reference/advisers">Search SEC Form ADV investment adviser filings by name, CIK, or state.</Card>
<Card title="Agent" icon="square-stack" href="/api-reference/agent">Bootstrap agent API keys, sponsor tokens, billing snapshots, limits, and MCP install metadata.</Card>
<Card title="Alerts" icon="square-stack" href="/api-reference/alerts">Retrieve free-tier alert limits and register emails for the alerts signup flow.</Card>
...
<Card title="Delivery" icon="square-stack" href="/api-reference/delivery">Inspect delivery ledger records, export delivery history, and manage monitor email unsubscribes.</Card>
...
<Card title="Embed" icon="square-stack" href="/api-reference/embed">Serve a cacheable public situations feed and widget script for third-party sites.</Card>
...
<Card title="Event Types" icon="square-stack" href="/api-reference/event_types">List Delivery event types with producer status, replay support, retention, and billing family metadata.</Card>
...
<Card title="Forms" icon="square-stack" href="/api-reference/forms">Form-specific SEC filing feeds and structured Form D offering data.</Card>
<Card title="Funds" icon="square-stack" href="/api-reference/funds">Return the latest SEC N-PORT holdings roster with explicit capability semantics and balance-unit metadata.</Card>
...
<Card title="Intelligence" icon="square-stack" href="/api-reference/intelligence">Research-ready intelligence bundles for issuers, portfolios, macro exposure, filings, and watchlists.</Card>
<Card title="Macro" icon="square-stack" href="/api-reference/macro">Country macro observations, release calendars, sovereign ratings, forecasts, regimes, source-health status, and high-signal packs.</Card>
...
<Card title="Metrics" icon="square-stack" href="/api-reference/metrics">Return latest or as-of Coverage Grid metric rows and per-security valuation-band history.</Card>
...
<Card title="Screener" icon="square-stack" href="/api-reference/screener">Reference pages for Screener endpoints.</Card>
...
<Card title="Stream" icon="square-stack" href="/api-reference/stream">Short-lived WebSocket stream tickets and delivery event streaming.</Card>
