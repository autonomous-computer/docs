...
<Card title="Diagnostics" icon="shield-check" href="/api-reference/diagnostics">Delivery and request introspection for debugging, support, and admin workflows.</Card>
