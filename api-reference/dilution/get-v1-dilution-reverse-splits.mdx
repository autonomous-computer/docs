...
Use SEC API `GET /v1/dilution/reverse-splits` to API historical reverse-split actions. Preserve `requestId`, `traceparent`, and `verification`. Report ratios as `splitFrom:splitTo` (e.g. `10:1`).
</Prompt>
