...
Use SEC API GET /v1/search/semantic to find conceptually similar SEC filing sections with hybrid ranking and citations. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
