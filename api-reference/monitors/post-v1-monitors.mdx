...
Use SEC API POST /v1/monitors to create a saved-search monitor with optional webhook or email delivery destination. Preserve `requestId`, `traceparent` in the output. Return a concise summary and keep the structured fields your application needs for follow-up requests.
</Prompt>
