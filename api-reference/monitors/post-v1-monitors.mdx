...
Use SEC API POST /v1/monitors to create a saved-search monitor with optional webhook or email delivery destination. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
