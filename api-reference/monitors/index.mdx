...
Use Monitors endpoints to create saved-search monitors, update delivery destinations, run saved-query match checks, and compile natural-language alert requests into structured monitor specs.
