...
Use SEC API GET /v1/monitors/{monitor_id}/matches to run the monitor's saved query and return new matches since last_checked_at. Preserve `requestId`, `traceparent` in the output. Keep the response fields your application uses for follow-up requests.
</Prompt>
