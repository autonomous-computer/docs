---
title: "Status"
description: "Check the current SEC API production surface and operational status so you know what is live before you build against it."
---
...
- include the UTC timestamp and org id if known
- include whether the failure was API, webhook, stream, billing, or MCP related

## Support workflow

- first inspect `https://api.secapi.ai/healthz`
- then include the org id and `Request-Id` in the support ticket so the SEC API team can inspect internal account and request records
