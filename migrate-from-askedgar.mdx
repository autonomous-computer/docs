...
<CardGroup cols={2}>
  ...
  <Card title="Hosted MCP and SDKs" icon="bot" href="/mcp-workflows">
    104 MCP tools, including dilution workflows, and 4 SDKs (JS, Python, Go, Rust). AskEdgar also documents an MCP surface with API tools generated from OpenAPI, documentation tools, and Bearer API-key forwarding.
  </Card>
</CardGroup>
