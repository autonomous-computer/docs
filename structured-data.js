(function () {
  ...
  var pages = {
    ...
    "/mcp-install": {
      ...
      description: "Install SEC API's hosted MCP server in agent clients with API-key authentication and source-preserving SEC filing tools.",
      breadcrumb: ["Hosted MCP", "MCP server installation"],
      sameAs: [marketingOrigin + "/agents/sec-filings-mcp-server"],
    },
    "/give-this-prompt-to-your-agent": {
      type: "TechArticle",
      title: "Give this prompt to your agent",
      description: "A ready-to-use prompt for coding agents that need SEC API auth, billing guardrails, citation discipline, and endpoint selection.",
      breadcrumb: ["Agent quickstart", "Give this prompt to your agent"],
      sameAs: [marketingOrigin + "/agents/sec-api-for-ai-agents", marketingOrigin + "/agents/AGENTS.md"],
    },
    "/token-efficiency": {
      type: "TechArticle",
      title: "Token efficiency",
      description: "Use compact SEC API response shapes, token headers, and cost metadata to keep agent workflows cheaper and easier to verify.",
      breadcrumb: ["Interactive tools", "Token efficiency"],
      sameAs: [marketingOrigin + "/proof/sec-api-token-savings-compact-response-benchmark"],
    },
    "/coverage-and-depth": {
      type: "TechArticle",
      title: "Coverage and depth",
      description: "Understand SEC API coverage layers, archive depth, source metadata, and coverage limitations for production workflows.",
      breadcrumb: ["Concepts and trust", "Coverage and depth"],
      sameAs: [marketingOrigin + "/proof/sec-filing-coverage-methodology"],
    },
    "/evaluate/sec-filing-search-api": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate SEC Filing Search API"],
      sameAs: [marketingOrigin + "/apis/filing-search", marketingOrigin + "/features/filing-search"],
    },
    "/evaluate/xbrl-facts-api": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate XBRL Facts API"],
    ...
    "/evaluate/13f-api": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate 13F API"],
      sameAs: [marketingOrigin + "/apis/ownership", marketingOrigin + "/workflows/13f-monitor-agent"],
    },
    "/evaluate/insider-trading-api": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate Insider Trading API"],
    ...
    "/evaluate/sec-filings-mcp-server": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate SEC Filings MCP Server"],
      sameAs: [marketingOrigin + "/agents/sec-filings-mcp-server"],
    },
    "/evaluate/sec-filing-rag": {
      ...
      breadcrumb: ["Evaluate SEC API", "Evaluate SEC Filing RAG"],
      sameAs: [marketingOrigin + "/guides/sec-filing-rag"],
    },
