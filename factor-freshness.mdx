...
- make long-history claims only for factors with row-level proof
...
| Fresh but missing requested history floor | Do not claim MAX or long-history coverage for that factor. |
