...
description: "Coverage statistics for SEC API's SEC EDGAR filing database — 18.5M+ filing manifests from 1993 to present"
---

SEC API indexes and serves SEC EDGAR filings from 1993 to present, with real-time detection of new filings within seconds of SEC publication.

## Coverage Summary

| Metric | Value |
|---|---|
| **Total filing manifests** | 18,563,938 |
| **EDGAR full index entries** | 26,965,974 |
| **Date range** | February 1993 – Present |
| **Enforcement records** | 5,993+ (back to 2003) |
| **Entity resolution coverage** | 8,466+ tracked entities |
| **Exchange enrichment** | 7,823 entities with exchange data |
| **New filing detection** | < 10 seconds (RSS poller) |

## Supported Filing Types

SEC API supports all SEC EDGAR filing types through generic filing search. The following have dedicated endpoints with structured extraction:
