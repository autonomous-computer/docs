---
title: "Migrate from Financial Datasets"
sidebarTitle: "Migrate from Financial Datasets"
---
...
<CardGroup cols={2}>
  <Card title="Primary-source lineage" icon="shield-check" href="/freshness-and-trust">
...
Translate this Financial Datasets integration to SEC API. Replace statement calls with the matching statement endpoints, use /v1/facts when tag-level values matter, move filing retrieval to /v1/filings, and preserve requestId, provenance, freshness, and plan headers in the integration layer.
</Prompt>
