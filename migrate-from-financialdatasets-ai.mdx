...
description: "Move financialdatasets.ai workflows onto SEC API while keeping the normalized statement views your analysis already depends on."
---

<Info>
This guide helps you swap `financialdatasets.ai` workflows onto SEC API without losing the normalized statement views you already depend on.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="More than statements" icon="layers-3" href="/getting-started">
...
<Prompt>
Translate this financialdatasets.ai integration to SEC API. Replace statement calls with the matching statement endpoints, use /v1/facts when tag-level values matter, move filing retrieval to /v1/filings, and preserve requestId, provenance, freshness, and plan headers in the integration layer.
</Prompt>
...
- Expect larger payloads than financialdatasets.ai on some statement calls because SEC API includes provenance and richer structure
