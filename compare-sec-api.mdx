...
| **Semantic search** | Yes (hybrid semantic search) | No |
...
| **SDKs** | JS and Python SDKs, plus Go and Rust REST guides | 2 (Python, Node.js) |
| **Homebrew** | Yes | No |
...
| **8-K 5.07 voting results** | **Yes (structured proposals, vote counts, approval outcomes)** | **No structured endpoint listed in the public docs** |
...
| Evaluation access | Account-specific billing state | 100 lifetime |
