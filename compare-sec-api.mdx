...
<Tip>
edgartools numbers are preliminary pending external methodology review. See [benchmark-results](/benchmark-results) and [compare-edgartools](/compare-edgartools) for the full comparison and reproducible methodology.
</Tip>
...
|---|---|---|---|
| **Free** | 150 calls (one-time) | 100 calls (lifetime) | Unlimited (MIT, truly free) |
...
| Free tier | 150 one-time, no card | 100 lifetime |
