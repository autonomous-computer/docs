---
title: "Rust SDK"
description: "Install and use the SEC API Rust SDK."
---
...
<CardGroup cols={3}>
  <Card title="Bootstrap client" icon="package" href="/libraries-and-sdks">
    Direct REST examples are available today; package installation will be documented here when the public crate is published.
  </Card>
...
<Steps>
  <Step title="Add the client">
    Add the public crate once it is available, or use direct REST calls with `SEC_API_KEY`.
  </Step>
...
When the crate is published, prefer the public crate name:
