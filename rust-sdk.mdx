...
Use the authenticated REST endpoints in the [Special Situations workflow](/special-situations-workflows) for the current public product. Do not write against unlisted Rust helpers for exports, archive reads, underwriting packs, or watch configuration.
