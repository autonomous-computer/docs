...
description: "Try SEC API data endpoints with copyable requests and your API key"
---
...
<Info>
These examples use live SEC API endpoints. [Get an API key](https://secapi.ai/login) to run them yourself.
</Info>
...
The public CLI package name is `@secapi/cli`, with the `secapi` binary. Use these commands once the package is available in your registry:
...
When the public JavaScript package is available, the intended npm package name is `@secapi/sdk`:
