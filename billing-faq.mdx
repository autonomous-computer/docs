...
When chat endpoints become available, they will count as well. Other meter classes, including filing reads, factor lookups, and market data, do not consume `ai_queries` quota.
