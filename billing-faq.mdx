...
No separate trial. Every new organization receives `150` included calls. The grant does not renew automatically. A qualified organization administrator can request a reset after 30 days, subject to account-risk checks; it is not a renewing monthly allowance.
