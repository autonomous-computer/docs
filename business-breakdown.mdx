---
title: "Business breakdown (segment analysis)"
description: "Get a multi-axis, revenue-anchored breakdown of a company's business with segment profit, margin, and year-over-year growth from the SEC API"
---
