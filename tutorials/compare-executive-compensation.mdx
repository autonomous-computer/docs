...
description: "Compare executive compensation across companies using the SEC API. Pull salary, bonus, stock awards, and total comp data. Includes curl, Python, and JavaScript examples."
---
