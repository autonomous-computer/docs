...
For the product workflow version, see the [13F monitor agent](https://secapi.ai/workflows/13f-monitor-agent), [13F glossary page](https://secapi.ai/glossary/13f), and [ownership feature overview](https://secapi.ai/features/ownership).

## What you will build

- A Python script that fetches 13F holdings from the SEC API
...
- **Use the product workflow**: The [13F monitor agent](https://secapi.ai/workflows/13f-monitor-agent) shows how this tutorial maps to an agent-ready SEC filing workflow.
- **Review 13F caveats**: The [13F glossary page](https://secapi.ai/glossary/13f) covers reporting lag, manager identity, and holdings limitations.
