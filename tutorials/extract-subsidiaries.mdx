...
Use this journey to start a corporate-structure or coverage-scope review from the latest 10-K Exhibit 21. The list contains significant subsidiaries disclosed by the filer; it is not a complete legal-entity graph, proof of control, or a substitute for legal diligence. The deliverable is a dated, source-linked snapshot that a reviewer can trace back to the exhibit.
