...
description: "Retrieve structured subsidiary data from SEC 10-K Exhibit 21 filings using the SEC API. Includes curl, Python, and JavaScript examples."
---
...
subs = client.company_subsidiaries(ticker="AAPL")
...
const subs = await client.companySubsidiaries({ ticker: "AAPL" });
...
for ticker in TICKERS:
    subs = client.company_subsidiaries(ticker=ticker)
...
```python
subs = client.company_subsidiaries(ticker="GOOG")
