...
Compare the issuer's delayed institutional disclosure with [13F holdings](/tutorials/monitor-13f-holdings), making the different source dates explicit. See the [insiders reference](/api-reference/insiders/get-v1-insiders) for all supported filters.
