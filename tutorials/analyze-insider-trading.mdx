...
This workflow helps an investor-relations, compliance, or research analyst review disclosed insider activity. It is not a buy/sell signal: an option exercise, tax withholding, gift, or planned sale can look like a directional transaction until the underlying filing is reviewed.
...
Run `node insider-queue.mjs`. Before interpreting a record, retrieve and review its Form 4 using the accession and filing URL.
