...
Use this workflow to turn the service-selected two latest parsable Form 13F
reports into a review artifact. Claude Code can format the artifact, but the API
response and linked filings remain the evidence. A 13F is a delayed reported
snapshot, not a current portfolio, trading blotter, or investment-intent signal.
