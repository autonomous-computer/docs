...
- An SEC API key (set as `SEC_API_KEY`)
...
4. Set **Path** to `sec-api-filings` (or any path you prefer).
...
```
https://your-n8n.example.com/webhook-test/sec-api-filings
```

Once the workflow is active, use the **Production URL** instead:

```
https://your-n8n.example.com/webhook/sec-api-filings
```
...
curl -X POST \
  ...
  -d '{
    "url": "https://your-n8n.example.com/webhook/sec-api-filings",
