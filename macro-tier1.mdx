...
SEC API provides allocator-grade macro data from official government sources — not third-party aggregators. Production data is refreshed daily by Dagster (`macro_official_source_sync_job` at 06:00 UTC).
