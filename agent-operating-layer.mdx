...
- 6 ready-to-run prompts: [/agents/prompt-library/insurance](/agents/prompt-library/insurance) (with v2 expansion when AAER MCP wrap merges)

## Monitoring

Support operators can track agent activity via the observability endpoint:
