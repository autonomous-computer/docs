...
SEC API Factor Intelligence provides a structured factor model spanning 84 factors across 5 categories. The surface supports factor catalog retrieval, historical and intraday returns, correlation analysis, per-stock exposure loadings, regime-conditioned performance, portfolio decomposition, and consolidated dashboard views.
