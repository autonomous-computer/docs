...
description: "See how the SEC API derives its major data surfaces, what each field means, and the source posture and confidence behind every value"
---
...
Sentiment scoring becomes available once it clears that bar; subscribe to the [changelog](/changelog) for the release.
