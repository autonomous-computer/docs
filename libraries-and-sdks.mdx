...
<CardGroup cols={2}>
  ...
  <Card title="SEC API Agent CLI" icon="terminal" href="#secapi-agent-cli">
...
The CLI wraps the same REST API surface for local scripts, smoke checks, and one-off workflows.
...
secapi owners 13f --cik 0001067983 --limit 25
```

Best when you want exact API workflows from the terminal without writing a small SDK script.
