---
title: "API Overview"
description: "How the SEC API REST, SDK, CLI, and MCP surfaces fit together."
---

# API Overview

<Info>
The API is built for real investor work. It keeps the contract compact, the source trail visible, partial-state behavior explicit, and the model consistent across REST, SDKs, CLI, and hosted MCP.
</Info>
