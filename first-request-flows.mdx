...
description: "Get to your first clean success with the SEC API by running one real workflow end to end before widening scope."
---
...
<Steps>
  ...
  <Step title="Resolve one issuer you know">
    Start with a company such as AAPL so you can spot identifier, company-name, or match-quality mismatches immediately.
  </Step>
