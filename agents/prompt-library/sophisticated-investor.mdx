...
<Note>v1 framing: forensic accounting (footnote forensics + insider/13F divergence + cash-flow stress). v2 expansion adds dilution forensics (warrants, convertibles, ATM-program tracking, cash runway) as the API surface expands.</Note>
...
<Note>**Coming soon** — this workflow references future MCP surfaces and is shown for visibility into the expansion roadmap.</Note>
