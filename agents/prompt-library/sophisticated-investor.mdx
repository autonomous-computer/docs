...
- State researcher-created calculations, their inputs, period alignment, and what the source does not disclose.
...
For thesis-critical findings, preserve the source filing, fiscal period, accession number, section or fact tag, and calculation inputs. A missing record, an anomalous output, or a reported holder change is a research question, not proof or a trading instruction.
