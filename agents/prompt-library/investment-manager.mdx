...
These prompts prepare research inputs; they do not recommend a trade. Keep the filing or dataset behind each claim, separate model output from source facts, and stop on auth, validation, billing, quota, or capability errors.
