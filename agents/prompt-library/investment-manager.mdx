...
Decision-relevant statements should name their source period and retrieval date. A 13F filing or Form 4 records a reported transaction or holding; neither establishes conviction, intent, value, or a trade instruction.
