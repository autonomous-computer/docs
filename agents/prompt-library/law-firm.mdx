...
- Cite the form, filing date, accession number, section, and source URL for each factual proposition.
- Use an intelligence or search result to find the record, then retrieve the cited filing section before characterizing it.
- Label an unanswered question as unanswered. Absence from a search result does not establish that the record set has been exhaustively located.
