---
title: "PR firm — Agent Prompt Library"
...
```bash
secapi agents prompts read pr-firm-voting-results-narrative
secapi agents prompts copy pr-firm-voting-results-narrative | pbcopy
```
...
1. `entities.resolve` — Resolve each client to best-match CIK
...
**Expected output:** Daily monitoring digest + client-comms scenario per event.
