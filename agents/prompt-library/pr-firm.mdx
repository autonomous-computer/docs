...
Keep the form, filing date, accession number, section, and source URL with each brief. Re-check the cited disclosure against the final client-facing language before publication.
