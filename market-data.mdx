...
Supported index inventory. Returns index metadata, rights status, and sync cadence.
...
Index constituent listings. See the [Index Constituents](/index-constituents) page for rights model and support status details.
