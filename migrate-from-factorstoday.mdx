...
This guide helps FactorsToday users map their existing workflows to SEC API equivalents. SEC API provides a broader factor catalog with deeper macro and credit factor coverage, plus unique portfolio intelligence overlays.
...
## Example: factor rotation strategy (SEC API exclusive)
