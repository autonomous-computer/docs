---
title: "13F Data API for Institutional Holdings Research"
description: "Retrieve an investment manager's filed Form 13F holdings, available report periods, and comparable reported changes with SEC filing evidence."
---
...
- [Create an API key, list a manager's reports, and select one quarter](https://secapi.ai/signup)
