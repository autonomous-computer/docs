...
description: "Search SEC filings by company, form type, date range, and content. Full-text and semantic search across millions of EDGAR documents. Get started free at secapi.ai/signup."
---

Search across every filing on SEC EDGAR without building your own index. SEC API provides keyword search, filtered queries, and AI-powered semantic search across millions of documents.

<CardGroup cols={3}>
  <Card title="Evaluate this workflow" icon="clipboard-check" href="/evaluate/sec-filing-search-api">
    Run a filing-search proof of concept before committing to the endpoint set.
  </Card>
  <Card title="Pricing and limits" icon="gauge" href="/evaluate/pricing-and-limits">
    Check meter classes, budget controls, and quota posture for repeated search.
  </Card>
  <Card title="Get an API key" icon="key-round" href="https://secapi.ai/signup">
    Create an account and test against the live API.
  </Card>
</CardGroup>
...
SEC API handles all of this. You get a single API endpoint that supports:
...
For the marketing and evaluation view, see the [EDGAR Filing Search API page](https://secapi.ai/apis/filing-search), [SEC EDGAR filing statistics](https://secapi.ai/statistics), and the [10-K glossary page](https://secapi.ai/glossary/10-k).
...
## Why SEC API over alternatives

| Feature | SEC API | EDGAR EFTS | Bloomberg | Refinitiv |
|---------|-----------|-----------|-----------|-----------|
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an account and start searching filings in under 60 seconds.
</Card>
...
- [EDGAR Filing Search API on secapi.ai](https://secapi.ai/apis/filing-search)
- [SEC EDGAR Filing Statistics](https://secapi.ai/statistics)
