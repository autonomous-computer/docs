...
description: "Search SEC filings by meaning, not just keywords. AI-powered semantic search finds relevant passages across millions of filings even when exact terms differ. Get started free at secapi.ai/signup."
---
...
For product and agent context, see the [Search feature page](https://secapi.ai/features/search), [semantic search glossary page](https://secapi.ai/glossary/semantic-search), and [SEC filing RAG guide](https://secapi.ai/guides/sec-filing-rag).
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Start searching SEC filings by meaning in under 60 seconds. 150 free API calls (one-time).
</Card>

- [Full-Text Search API](/seo/sec-full-text-search-api)
- [10-K Section Extraction API](/seo/sec-10k-section-extraction-api)
- [API Reference](/api-reference)
- [Search feature overview](https://secapi.ai/features/search)
- [SEC Filing RAG guide](https://secapi.ai/guides/sec-filing-rag)
