...
description: "Access structured SEC enforcement action data via API. Search by violation type, respondent, date range, and penalty amount. Track fraud cases and regulatory trends. Get started free at secapi.ai/signup."
---
