---
title: "SEC Enforcement Actions API for Source-Linked Screening"
description: "Search SEC litigation releases, administrative proceedings, and AAERs with bounded filters and source links for compliance and diligence research."
---
...
Run a narrow source-family and date query, retain the release URL and identifiers, then open the SEC document before adding a finding to diligence or compliance output.
