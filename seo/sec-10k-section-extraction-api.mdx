...
description: "Extract individual sections from SEC 10-K filings via API. Get Item 1 (Business), 1A (Risk Factors), 7 (MD&A), 7A (Market Risk), and 8 (Financial Statements) as clean text. Get started free at secapi.ai/signup."
---
