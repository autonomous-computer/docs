---
title: "SEC EDGAR API — Structured SEC Filing Data for Developers and AI Agents"
description: "Use SEC API as a production EDGAR API for filings, statements, ownership, search, and agent workflows. Get structured JSON with source URLs, accession numbers, and freshness metadata."
---

The fastest way to get structured data from SEC EDGAR into your application or AI agent. SEC API indexes EDGAR filings and exposes them through REST, SDKs, CLI, and hosted MCP with normalized schemas, cursor pagination, request IDs, source URLs, accession numbers, and freshness metadata.
...
## What a good EDGAR API proof should prove

A serious evaluation should not stop at "can I get a filing?" Run one end-to-end workflow and verify:
...
| Feature | SEC API | Raw EDGAR | sec-api.io | Financial Datasets |
|---------|-----------|-----------|------------|-------------------|
...
Start with 150 free API calls. Pay-as-you-go pricing scales with your usage. No upfront commitments.
