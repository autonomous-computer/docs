...
description: "Access SEC EDGAR filings, financial statements, ownership data, and more through a modern REST API. No SGML parsing. No rate-limit headaches. Get started free at secapi.ai/signup."
---
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an account and start making requests in under 60 seconds.
</Card>
