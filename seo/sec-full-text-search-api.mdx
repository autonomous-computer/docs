...
description: "Search the full text of SEC filings with keyword and AI-powered semantic search. Find risk factors, M&A disclosures, and specific clauses across millions of documents. Get started free at secapi.ai/signup."
---
...
| Feature | SEC API | EDGAR EFTS | Bloomberg Terminal | S&P Capital IQ |
|---------|-----------|-----------|-------------------|----------------|
