...
description: "Access structured executive compensation data from SEC proxy statements (DEF 14A) via API. Compare CEO pay across companies, analyze comp structure, and track trends. Get started free at secapi.ai/signup."
---

Public companies disclose executive compensation in annual proxy statements (DEF 14A). SEC API extracts and structures the Summary Compensation Table so you can access salary, bonus, stock awards, option awards, and total compensation for named executive officers through a simple API.
...
## Why SEC API for compensation data

| Feature | SEC API | Raw DEF 14A | Equilar | ISS |
|---------|-----------|-------------|---------|-----|
