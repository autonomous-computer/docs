...
description: "Retrieve filed annual or quarterly normalized statements with reporting-period, unit, and filing evidence for models, screens, and research workflows."
---

Use this API when a workflow needs a filed income statement, balance sheet, or cash-flow statement in a normalized shape. The returned rows are useful only alongside the periods, units, and filing context that identify what is being compared.
...
- [Create an API key and test a statement request](https://secapi.ai/signup)
