...
description: "Stream SEC filings the moment they hit EDGAR with WebSocket and webhook APIs. Sub-minute latency, filterable by form type and ticker. Get started free at secapi.ai/signup."
---
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Start streaming SEC filings in under 60 seconds. 150 free API calls (one-time).
</Card>
