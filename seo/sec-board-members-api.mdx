...
description: "Access structured board of directors data extracted from SEC proxy statements (DEF 14A) via API. Track board composition, independence, committees, and tenure. Get started free at secapi.ai/signup."
---
