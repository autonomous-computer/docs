...
Bundle observability config, usage summary, billing health, and recent events into a single operator-only response for support or pre-production validation:
