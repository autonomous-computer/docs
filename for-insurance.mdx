...
| `/v1/filings/latest/sections/{section_key}` | `GET` | Extract specific sections (auditor report, risk factors) |
...
```bash
curl -H "x-api-key: $SEC_API_KEY" \
  "https://api.secapi.ai/v1/filings/latest/sections/item_9a?ticker=XYZ&form=10-K&view=compact"
```
...
_See the full 6-prompt [Insurance & risk library](/give-this-prompt-to-your-agent)._
