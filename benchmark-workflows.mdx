...
## Jump to the matching API surface

- return decomposition → [`GET /v1/factors/decomposition`](/api-reference/factors/get-v1-factors-decomposition)
- factor-neutral or prompt-compiled portfolio work → [`POST /v1/intelligence/query`](/api-reference/intelligence/post-v1-intelligence-query)
- related stocks → [`GET /v1/factors/related-stocks`](/api-reference/factors/get-v1-factors-related-stocks)
- regime-aware screens → [`GET /v1/factors/screen`](/api-reference/factors/get-v1-factors-screen) and [`POST /v1/strategies/regime-screen`](/api-reference/strategies/post-v1-strategies-regime-screen)
- market reference and estimates → [`GET /v1/market/reference`](/api-reference/market/get-v1-market-reference) and [`GET /v1/market/estimates`](/api-reference/market/get-v1-market-estimates)
