# SEC API Sentiment Score Gate

## Current posture

- SEC API Sentiment Score is intentionally not public yet
- there is no `/v1/signals/sentiment` endpoint in the 3.0 surface
- the JavaScript SDK and generated API reference intentionally omit any public sentiment method until the gate clears
