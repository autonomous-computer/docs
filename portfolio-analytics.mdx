...
SEC API provides allocator-grade portfolio analytics: factor exposure analysis, optimization recommendations, and stress testing — all in one API call.
...
- [Make Portfolio Factor Neutral](/custom-skills#built-in-skills) — Interactive workflow for portfolio neutralization
- [Decompose Return and Hedge](/custom-skills#built-in-skills) — Attribution and hedge ideas for individual positions
