...
SEC API provides an allocator-grade factor model spanning 230+ factors across 7 categories: market, style, macro, sector, industry, country, and thematic. The model follows a hierarchical purification architecture consistent with institutional standards pioneered by MSCI Barra and adopted by Axioma (Qontigo), Bloomberg PORT, and Northfield.
