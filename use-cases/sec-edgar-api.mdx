...
description: "Access SEC EDGAR filings, financial statements, ownership data, and more through a modern REST API. No SGML parsing and no screen-scraping."
---
...
<CardGroup cols={2}>
  ...
  <Card title="No rate limiting headaches" icon="gauge">
...
- **Python**: `pip install sec-api-py`
- **JavaScript/TypeScript**: `npm install @secapi/sdk`
- **Rust**: use the Rust REST guide until the crate is published
- **Go**: use the Go REST guide until the module is published
