...
EDGAR's 10 requests-per-second rate limit makes bulk document retrieval painfully slow. SEC API mirrors every filing document to a global Cloudflare R2 CDN, so you can download PDFs, HTML filings, and XML exhibits at 100+ requests per second with sub-100ms latency worldwide.

## Capabilities

<CardGroup cols={2}>
  <Card title="100+ req/sec throughput" icon="gauge">
