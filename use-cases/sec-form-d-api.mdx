...
description: "Access structured Form D data for private placements and Regulation D offerings via API. Track exempt offerings, fundraising rounds, and issuer details."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Amendment tracking" icon="file-check">
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an API key and start tracking private placements in under 60 seconds.
</Card>
