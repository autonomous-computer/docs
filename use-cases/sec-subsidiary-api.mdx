...
description: "Access structured subsidiary data extracted from SEC Exhibit 21 filings via API. Map corporate hierarchies, jurisdictions, and ownership structures."
---
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an API key and start mapping corporate structures in under 60 seconds.
</Card>

- [SEC EDGAR API](/use-cases/sec-edgar-api)
- [Company Search API](/use-cases/sec-company-search-api)
