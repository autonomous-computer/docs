...
description: "Access structured 13F institutional holdings data via API. Compare holdings quarter over quarter, track position changes, and monitor the largest investors."
---
...
Monitor when the largest hedge funds and asset managers add or exit positions. The compare endpoint APIs exactly what changed.
