...
description: "Search SEC-registered companies by ticker, CIK, CUSIP, FIGI, ISIN, or name. Resolve any identifier to a unified entity profile with full filing history."
---

# SEC Company Search API

Finding the right company on EDGAR means knowing its CIK. SEC API's entity resolution engine lets you search by any identifier — ticker symbol, CIK, CUSIP, FIGI, ISIN, or company name — and get back a unified entity profile with all mapped identifiers and filing metadata.
...
<CardGroup cols={2}>
  ...
  <Card title="Fuzzy name matching" icon="search">
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an API key and start resolving entities in under 60 seconds.
</Card>
