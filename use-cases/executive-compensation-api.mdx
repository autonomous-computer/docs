...
description: "Access structured executive compensation data from SEC proxy statements (DEF 14A) via API. Compare CEO pay across companies, analyze comp structure, and track trends."
---
