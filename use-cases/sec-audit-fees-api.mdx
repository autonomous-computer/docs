...
description: "Access structured audit fee data extracted from SEC proxy statements (DEF 14A) via API. Track audit, audit-related, tax, and all other fees by company."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Independence analysis" icon="scale">
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an API key and start pulling audit fee data in under 60 seconds.
</Card>
