...
description: "Compare SEC filing amendments side by side via API. Detect changes between 10-K/A, 10-Q/A, and other amended filings with structured diffs."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Numeric change detection" icon="hash">
...
curl -H "x-api-key: $SEC_API_KEY" \
  "https://api.secapi.ai/v1/filings/0000320193-24-000081/diff?against=0000320193-25-000003"
```
...
|----------|-------------|
| `GET /v1/filings/{accession_number}/diff` | Compare one filing accession number against another filing |
...
<Card title="Get your API key" icon="key" href="/getting-started">
  Create an API key and start comparing SEC filings in under 60 seconds.
</Card>
