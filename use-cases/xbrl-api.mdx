...
description: "Access structured XBRL financial data from SEC filings via API. No XML parsing, no taxonomy mapping, no SGML headaches. Get normalized facts and statements instantly."
---
