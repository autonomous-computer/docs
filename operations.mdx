...
```bash
SECAPI_BASE_URL=https://your-api.example.com \
SECAPI_API_KEY=... \
...
<Prompt>
Run the SEC API release verification flow against the target environment. Check health, readiness, OAuth discovery, and limits. If any step fails, report the failing endpoint, requestId, and likely blast radius before attempting rollout.
</Prompt>
