...
<Update label="May 21, 2026" description="maintenance update: add DMS CDC staging resources + 10 more" tags={["SEC API", "Release"]}>
Highlights from this shipping window include maintenance update: add DMS CDC staging resources; maintenance update: guard large Postgres cutovers; maintenance update: harden Postgres migration task wait.

### Highlights

- maintenance update: add DMS CDC staging resources
- maintenance update: guard large Postgres cutovers
- maintenance update: harden Postgres migration task wait
- maintenance update: target Postgres 18 state plane
</Update>
...
<Update label="May 2, 2026" description="fix(provision): clear BetterStack pair with blank values + 1 more" tags={["SEC API", "Release"]}>
Highlights from this shipping window include fix(provision): clear BetterStack pair with blank values; fix(api): harden rate-limit client identity.

### Highlights

- fix(provision): clear BetterStack pair with blank values
...
<Update label="April 9, 2026" description="fix: output webhook secret to stderr in CI where.secret file is lost (fast-follow from PR #251 bot review)" tags={["SEC API", "Release"]}>
A focused product or platform improvement shipped to SEC API.
