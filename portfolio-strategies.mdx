...
Portfolio optimization across three objectives. Returns bounded candidate scenarios, expected-return/risk proxies, constraint satisfaction metadata, and non-advice disclosures.
...
Optimizer outputs are analytical model scenarios for research and engineering workflows, not personalized investment advice.
