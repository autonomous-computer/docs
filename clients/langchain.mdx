...
- **Streaming notifications missing** — if your adapter version does not API MCP progress events, tool calls can still complete while long-running progress updates are omitted.
