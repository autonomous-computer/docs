---
title: "Institutional Ownership & Insider Trading API"
description: "Query 13F holdings, Forms 3/4/5 insider trades, beneficial ownership, and compensation data through one SEC API surface."
---
...
Ownership data is scattered across multiple SEC form types and filing families. The SEC API Ownership surface normalizes 13F institutional holdings, insider trades, beneficial ownership filings, and compensation disclosures into a single query interface with cross-quarter comparison built in.
...
For buyer-facing workflow context, see the [Ownership feature page](https://secapi.ai/features/ownership), [insider trading monitor workflow](https://secapi.ai/workflows/insider-trading-monitor), and [13F monitor workflow](https://secapi.ai/workflows/13f-monitor-agent).
...
- [Ownership feature overview](https://secapi.ai/features/ownership)
- [Insider trading monitor workflow](https://secapi.ai/workflows/insider-trading-monitor)
- [13F monitor workflow](https://secapi.ai/workflows/13f-monitor-agent)
