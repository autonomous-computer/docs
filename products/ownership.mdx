...
Track institutional holders, insider transactions, and beneficial ownership across SEC disclosures. 13F holdings, Forms 3/4/5 insider trades, executive compensation, and board composition in one API family.

## Why use this

Ownership data is scattered across multiple SEC form types and filing families. The SEC API Ownership API normalizes 13F institutional holdings, insider trades, beneficial ownership filings, and compensation disclosures into a single query interface with cross-quarter comparison built in.
