---
title: "Entity Resolution & Mapping API — SEC API"
description: "Resolve CIK, ticker, FIGI, ISIN, CUSIP, or company name to a best-match SEC entity record with the SEC API entity graph."
---
