---
title: "SEC Enforcement Actions API — SEC API"
description: "Query SEC enforcement records across litigation releases, administrative proceedings, and AAERs with structured filters via the SEC API."
---
...
SEC enforcement data is published across multiple release types with no unified query surface. The SEC API Enforcement API normalizes litigation releases, administrative proceedings, and AAERs into a single searchable index with structured violation, respondent, and penalty fields.
