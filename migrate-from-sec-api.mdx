---
title: "Migrate from sec-api.io"
sidebarTitle: "Migrate from sec-api.io"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Request diagnostics" icon="search-code" href="/status">
    `Request-Id` is first-class across the REST API so support and debugging workflows stay sane.
  </Card>
  <Card title="Shared REST and MCP API" icon="bot" href="/mcp-workflows">
...
<CardGroup cols={3}>
  <Card title="Migrate from Financial Datasets" icon="git-compare-arrows" href="/migrate-from-financialdatasets-ai">
