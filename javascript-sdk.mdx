...
<Prompt>
Install the JavaScript SDK for Omni Datastream in this project. Resolve AAPL, fetch the latest 10-K, fetch the latest market snapshot, read US CPI, run the semantic intelligence query for AAPL return decomposition, and log requestId, traceparent, provenance, freshness, and materialization metadata with each response.
</Prompt>
