...
Current JavaScript SDK releases expose the read helpers documented in their package API, including list, detail, feed, calendar, stats, and performance. For exports, archive reads, underwriting packs, and watch configuration, call the authenticated REST endpoints in the [Special Situations workflow](/special-situations-workflows). Do not assume a nested `situations` namespace or a watch helper is available in an installed package.
