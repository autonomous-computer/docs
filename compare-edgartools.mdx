...
description: "Feature-by-feature comparison of SEC API and edgartools — speed, cost, agent support, and commercial posture"
hidden: true
---
...
- Hosted semantic search, dilution intelligence, hosted MCP surface, monitors, etc.
...
| Hosted MCP surface                          | Yes                             | Not in the edgartools Python library |
