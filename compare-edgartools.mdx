...
Every number on this page is a first-party measurement: each comparand runs through a dedicated benchmark runner under identical conditions, with a shared scorecard step assembling the four-way comparison. If you spot a number that looks off, email support@secapi.ai.
