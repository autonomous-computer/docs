---
title: "SEC API vs edgartools"
description: "Feature-by-feature comparison of SEC API and edgartools — speed, cost, agent support, and commercial status"
hidden: true
---

<Warning>
**Preliminary — pending external methodology review.** Numbers on this page
come from the reproducible benchmark harness described in
...
workflows we use to benchmark against sec-api.io and Financial Datasets.
...
([methodology](https://github.com/autonomous-computer/sec-api/blob/main/benchmarks/METHODOLOGY.md)):
...
| ---------------- | ------------------------------------------- | ----------------------- |
| **Free**         | Check current billing state after signup       | Unlimited (truly free)  |
| **Pay-as-you-go**| From $0.01/call                             | Not applicable          |
| **Personal**     | $55/mo or $588/yr                           | $0                      |
| **Team**         | $239/mo or $2,388/yr                        | $0                      |
| **Commercial**   | From $18,000/yr                             | None (community-supported) |
...
- Hosted semantic search, dilution intelligence, hosted MCP API, monitors, etc.
- JavaScript and Python SDKs, plus Go and Rust REST guides (edgartools is Python-only)
...
| Hosted MCP API                          | Yes                             | Not in the edgartools Python library |
| SDKs                                        | JS and Python SDKs; Go and Rust REST guides            | Python-only                     |
...
- `scripts/bench/benchmark_search.py` (SEC API)
...
Run them yourself to compare the same operations in your own environment.
