...
Rate-limited requests receive a clear error message with a retry-after interval. The WebSocket connection stays open, so interactive workflows can continue after the backoff window.
