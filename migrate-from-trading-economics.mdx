...
This guide helps Trading Economics users map their existing workflows to SEC API equivalents. SEC API provides a narrower macro surface focused on high-signal indicators with factor-aware intelligence overlays.
...
| Country overview | `POST /v1/intelligence/country-report` | Factor-aware country analysis |
| N/A | `GET /v1/macro/high-signal-pack` | Curated daily indicator bundles per country |
| N/A | `GET /v1/macro/regimes` | Macro regime classification |
