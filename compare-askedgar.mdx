...
| MCP server                                              | yes (103 tools, including dilution workflows) | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
...
- You need SEC API's 103-tool catalog, multi-language SDKs, or signed webhooks.
...
| MCP server                       | yes (103 tools)                     | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
