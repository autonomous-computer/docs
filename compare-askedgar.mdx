...
| MCP server                                              | yes (102 tools, including dilution workflows) | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
...
- You need SEC API's 104-tool catalog, multi-language SDKs, or signed webhooks.
...
| MCP server                       | yes (102 tools)                     | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
