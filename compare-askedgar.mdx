...
The SEC API verification surface is available in the public response schema.
...
- SEC API Personal **$55/month** or **$588/year** (predictable, includes the rest of the 39-family API surface)
...
as a first-class surface (4 SDKs, 8 Skills, MCP server, signed webhooks,
structured CLI).
