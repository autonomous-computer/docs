...
- **Tight vertical scope** — schema, alerts, and Discord
...
| MCP server                                              | yes (106 tools, including dilution workflows) | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
...
| MCP server                       | yes (106 tools)                     | yes ([documented MCP](https://askedgar.readme.io/docs/mcp-ai); API tools generated from OpenAPI plus documentation tools; Bearer API-key forwarding) |
