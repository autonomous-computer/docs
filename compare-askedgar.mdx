...
| ----------------- | ----------------------------------------------- | -------------------------------------- | ---------------- |
| **Free**          | 150 calls (one-time)                            | Limited AI questions                   | None             |
...
- **Polished AI Copilot UI** for non-engineer operators. SEC API is API-first
...
| MCP server                                              | yes (74 tools, including 14 dilution.*) | no                              |
...
| Onboarding                       | Free account; explicit key creation | API-key request flow + per-KB billing |
| OpenAPI                          | yes (Zod-generated)                 | not publicly linked from /docs |
| MCP server                       | yes (74 tools)                      | no                             |
